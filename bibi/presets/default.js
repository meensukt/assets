...
"bookshelf" : "https://tstore-ebook.oss-ap-southeast-3.aliyuncs.com", // Relative path from this preset file to the bookshelf directory. "/" at the end is ignored. (To use a path begins with "http(s)://", read <01> at the bottom of this preset file.)
...
/* !!!! BE CAREFUL !!!! */ "trustworthy-origins" : ["https://tstore-ebook.oss-ap-southeast-3.aliyuncs.com/"], // origins you trust other than where this Bibi is installed. (blank is recommended).
