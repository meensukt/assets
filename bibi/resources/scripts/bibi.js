        ...
        var N = {
                initialize: function() {
                  ...
                  let alibaba = new URLSearchParams(window.location.search);
                    ...
                    e && (N.bookshelf = new URL(e, newurl), document.body.getAttribute("data-bibi-book") && (N.book = document.body.getAttribute("data-bibi-book"));
...
// + "?OSSAccessKeyId=" + alibaba.get('OSSAccessKeyId') + "&Expires=" + alibaba.get('Expires') + "&Signature=" + alibaba.get('Signature')
