        ...
        (function(e) {
            ...
            return new Promise((function(e, t) {
                ...
                var i = !1,
                    ...
                    console.log(F.book)
                    console.log(i)
                    console.log(U.isToBeExtractedIfNecessary(F.book))
            ...
            return Promise.resolve().then((function() {
                return x.busyHerself(), H.note("Loading..."), U.log("Initializing Book...", "<g:>"), console.log("initializingBook..."), k.initializeBook(e).then((function(e) {
                    ...
                    return new Promise((function(t, n) {
                      ...
                      console.log(n)
                        ...
                        if (A.Type = F.book ? F.zine ? "Zine" : "EPUB" : "", "EPUB" != A.Type && (A.ZineData = {
                              ...
                              console.log("chose way1")
                            if (U.Local){console.log("error:bibi cannot open book"); return n("Bibi can't open books via ".concat(N.book ? "data-bibi-book" : "URL", " on local mode"));}
                            A.Path = e.Book;
                            console.log("setting A.Path as: "+A.Path)
                                  ...
                                  console.log(e);
                                    return {
                                        Promised: ("folder" == e ? U.download(o).then((function() {
                                          ...
                                          console.log("then we consider A.ExtractionPolicy")
                                          console.log(n)
                          ...
                          console.log("chose way2")
                            ...
                            U.loadZippedBookData(l).then((function() {
                              console.log("after we loadZippedBookData... THennNN!!..")
        ...
        var N = {
                initialize: function() {
                  ...
                  let alibaba = new URLSearchParams(window.location.search);
                    ...
                    e && (N.bookshelf = new newurl), document.body.getAttribute("data-bibi-book") && (N.book = document.body.getAttribute("data-bibi-book"));
//TODO
...
//TODO
        ...
        U.log.initialize = function() {
          ...
          return e.Retlieving = U.RangeLoader.getBuffer(e.Path).then((function(t) {
            ...
            console.log('error inside U.extract, U.RangeLoader.getBuffer got screwed')
            console.log(t)
...
let src = new URL(e, t).href + "?OSSAccessKeyId=" + alibaba.get('OSSAccessKeyId') + "&Expires=" + alibaba.get('Expires') + "&Signature=" + alibaba.get('Signature')
          ...
          console.log("U.getContentType")
          console.log(e)
            for (var t in U.ContentTypes) {
              if (new RegExp("\\." + t + "$").test(e)) {
                console.log("returning:"+U.ContentTypes[t])
